...
async def visionrecognizer(request):
    ...
    if config.visionrecognizer_url() is None or config.visionrecognizer_bearer_token() is None:
    ...
    outgoing_request_headers = {'Authorization': 'Bearer ' + config.visionrecognizer_bearer_token()}
